...
def check_haarcascadefile():
    exists = os.path.isfile(r"C:\Users\shukl\Downloads\fr1\fr1\haarcascade_frontalface_default.xml")
    if exists:
        pass
    else:
...
def TakeImages():
    ...
    assure_path_exists(r"C:\Users\shukl\Downloads\fr1\StudentDetails")
    assure_path_exists(r"C:\Users\shukl\Downloads\fr1\TrainingImage")
    serial = 0
    exists = os.path.isfile("StudentDetails\StudentDetails.csv")
    if exists:
        with open(r"C:\Users\shukl\Downloads\fr1\StudentDetails\StudentDetails.csv") as csvFile1:
        ...
        with open(r"C:\Users\shukl\Downloads\fr1\StudentDetails\StudentDetails.csv", 'a+') as csvFile1:
    ...
    if ((name.isalpha()) or (' ' in name)):
        ...
        harcascadePath = r"C:\Users\shukl\Downloads\fr1\fr1\haarcascade_frontalface_default.xml"
        ...
        while (True):
            ...
            for (x, y, w, h) in faces:
                ...
                cv2.imwrite(r"C:\Users\shukl\Downloads\fr1\TrainingImage" + name + "." + str(serial) + "." + Id + '.' + str(sampleNum) + ".jpg",
                            gray[y:y + h, x:x + w])
                # display the frame
        ...
        row = [serial, '', Id, '', name]
        with open(r'C:\Users\shukl\Downloads\fr1\StudentDetails\StudentDetails.csv', 'a+') as csvFile:
...
def TrainImages():
    ...
    try:
        ...
        return
    recognizer.save(r"C:\Users\shukl\Downloads\fr1\StudentDetails\Trainner.yml")
